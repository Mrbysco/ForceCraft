...
public class ForceFeatureConfigs {
	...
	public static final ConfiguredFeature<TreeConfiguration, ?> FORCE_TREE = FeatureUtils.register("forcecraft:force_tree",
			ForceFeatures.FORCE_TREE.get().configured(createForceTree().build()));

	private static final BeehiveDecorator BEEHIVE_005 = new BeehiveDecorator(0.05F);
	public static final ConfiguredFeature<TreeConfiguration, ?> FORCE_TREE_WITH_MORE_BEEHIVES_CONFIG = FeatureUtils.register("forcecraft:force_tree_with_bees",
			ForceFeatures.FORCE_TREE.get().configured(createForceTree().decorators(List.of(BEEHIVE_005)).build()));

	public static final PlacedFeature PLACED_FORCE_TREE = PlacementUtils.register("forcecraft:force_tree",
			ForceFeatureConfigs.FORCE_TREE.filteredByBlockSurvival(ForceRegistry.FORCE_SAPLING.get()));
	public static final PlacedFeature PLACED_FORCE_TREE_BEES_002 = PlacementUtils.register("forcecraft:force_tree_bees_002",
			ForceFeatureConfigs.FORCE_TREE_WITH_MORE_BEEHIVES_CONFIG.filteredByBlockSurvival(ForceRegistry.FORCE_SAPLING.get()));

	public static final ConfiguredFeature<RandomFeatureConfiguration, ?> TREES_FORCE = FeatureUtils.register("forcecraft:trees_force",
