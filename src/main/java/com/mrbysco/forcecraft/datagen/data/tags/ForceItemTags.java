...
public class ForceItemTags extends ItemTagsProvider {
	...
	protected void addTags() {
		...
		this.tag(ForceTags.FORCE_FURNACES)
				.add(ForceRegistry.FORCE_FURNACE.get().asItem(), ForceRegistry.BLACK_FORCE_FURNACE.get().asItem(),
						ForceRegistry.BLUE_FORCE_FURNACE.get().asItem(), ForceRegistry.BROWN_FORCE_FURNACE.get().asItem(),
						ForceRegistry.CYAN_FORCE_FURNACE.get().asItem(), ForceRegistry.GRAY_FORCE_FURNACE.get().asItem(),
						ForceRegistry.GREEN_FORCE_FURNACE.get().asItem(), ForceRegistry.LIGHT_BLUE_FORCE_FURNACE.get().asItem(),
						ForceRegistry.LIGHT_GRAY_FORCE_FURNACE.get().asItem(), ForceRegistry.LIME_FORCE_FURNACE.get().asItem(),
