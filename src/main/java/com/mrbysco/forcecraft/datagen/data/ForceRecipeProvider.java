...
public class ForceRecipeProvider extends RecipeProvider {
	...
	protected void buildRecipes(Consumer<FinishedRecipe> output) {
		...
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(ForceTags.FORCE_LOGS), RecipeCategory.MISC,
				...
				.save(output);
		//Smoking
		simpleCookingRecipe(output, "smoking", RecipeSerializer.SMOKING_RECIPE, 100,
				ForceRegistry.RAW_BACON.get(), ForceRegistry.COOKED_BACON.get(), 0.1F);
		//Campfire cooking
		simpleCookingRecipe(output, "campfire_cooking", RecipeSerializer.CAMPFIRE_COOKING_RECIPE, 600,
				ForceRegistry.RAW_BACON.get(), ForceRegistry.COOKED_BACON.get(), 0.1F);
		//Blasting
		...
		new ShapelessStackRecipeBuilder(RecipeCategory.MISC, getGuideBook())
				.requires(Items.BOOK)
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ForceRegistry.FORCE_BRICK.get(), 8)
				...
				.define('F', ForceRegistry.FORCE_GEM.get())
				.unlockedBy("has_force_gem", has(ForceRegistry.FORCE_GEM.get()))
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ForceRegistry.FORCE_TORCH.get(), 4)
				.pattern("G")
				.pattern("S")
				.define('G', ForceRegistry.GOLDEN_POWER_SOURCE.get())
				.define('S', Tags.Items.RODS_WOODEN)
				.unlockedBy("has_golden_power_source", has(ForceRegistry.GOLDEN_POWER_SOURCE.get()))
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ForceRegistry.FORCE_WHITE_TORCH.get(), 8)
				...
				.pattern("TDT")
				.pattern("TTT")
				.define('T', ForceRegistry.FORCE_TORCH.get())
				.define('D', Tags.Items.DYES_WHITE)
				.unlockedBy("has_force_torch", has(ForceRegistry.FORCE_TORCH.get()))
...
//				.save(output);
		ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, ForceRegistry.FORCE_WRENCH.get())
				...
				.pattern(" F ")
				.define('F', ForceTags.FORCE_INGOT)
				.define('G', ForceRegistry.FORCE_GEAR.get())
				.unlockedBy("has_force_ingot", has(ForceTags.FORCE_INGOT))
				.unlockedBy("has_force_rod", has(ForceTags.FORCE_ROD))
				.save(output);
		ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, ForceRegistry.FORCE_MITT.get())
				...
				.save(output);
		//Rod
		ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, ForceRegistry.FORCE_ROD.get())
				.pattern("  F")
				.pattern(" S ")
				.pattern("N  ")
				.define('F', ForceTags.FORCE_INGOT)
				...
				.unlockedBy("has_force_rod", has(ForceTags.FORCE_ROD))
				.save(output);
		ItemStack damagedRod = new ItemStack(ForceRegistry.FORCE_ROD.get());
		damagedRod.setDamageValue(73);
		new ShapedStackRecipeBuilder(RecipeCategory.TOOLS, damagedRod)
				.pattern("  F")
				.pattern(" S ")
				.pattern("N  ")
				.define('F', ForceTags.FORCE_INGOT)
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ForceRegistry.FORCE_WOOD.get(), 3)
				...
				.unlockedBy("has_force_log", has(ForceRegistry.FORCE_LOG.get()))
				.save(output);
		//Force Belt
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ForceRegistry.FORCE_FLASK.get(), 3)
				...
				.unlockedBy("has_glass", has(Tags.Items.GLASS))
				.save(output);
		NoRemainderShapelessBuilder.shapeless(RecipeCategory.MISC, ForceRegistry.FORCE_FLASK.get())
				.requires(Ingredient.of(ForceTags.ENTITY_FLASKS))
	...
	private void addInfuserRecipes(Consumer<FinishedRecipe> output) {
		//0
		...
		InfuseRecipeBuilder.infuse(
						PartialNBTIngredient.of(invisibility.getTag(), Items.POTION),
		...
		ConditionalRecipe.builder()
				.addCondition(new ForceTorchRecipeCondition())
				.addRecipe(InfuseRecipeBuilder.infuse(
				...
				.build(output,
						new ResourceLocation(Reference.MOD_ID, "infuser/convert_time_torch"));
	...
	private void addMultiOutputRecipes(Consumer<FinishedRecipe> output) {
		MultipleOutputRecipeBuilder.freezing(Ingredient.of(Tags.Items.RODS_BLAZE), 0.1F, 200)
				.setResult(Items.BONE, 1)
				.unlockedBy("has_core", has(ForceRegistry.FREEZING_CORE.get()))
		...
		MultipleOutputRecipeBuilder.freezing(PartialNBTIngredient.of(waterBottle.getTag(), Items.POTION), 0.1F, 200)
	...
	private void addTransmutationRecipes(Consumer<FinishedRecipe> output) {
		//Mushrooms
		...
		//Force
		TransmutationRecipeBuilder.transmutation(ForceRegistry.FORCE_BRICK.get())
		...
		TransmutationRecipeBuilder.transmutation(ForceRegistry.FORCE_SAPLING.get())
		...
		TransmutationRecipeBuilder.transmutation(ForceRegistry.UPGRADE_CORE.get())
				.requires(PartialNBTIngredient.of(tag, ForceRegistry.EXPERIENCE_TOME.get()))
