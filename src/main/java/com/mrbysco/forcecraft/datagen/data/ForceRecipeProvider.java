...
public class ForceRecipeProvider extends RecipeProvider {
	...
	protected void buildRecipes(RecipeOutput output, HolderLookup.Provider provider) {
		...
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(ForceRegistry.FORCE_BRICK_RED.get()), RecipeCategory.BUILDING_BLOCKS, ForceRegistry.FORCE_BRICK_RED_STAIRS.get()).unlockedBy("has_bricks", has(ForceRegistry.FORCE_BRICK_RED.get())).save(output, Reference.modLoc("force_brick_red_stairs_from_force_brick_red"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(ForceRegistry.FORCE_BRICK_YELLOW.get()), RecipeCategory.BUILDING_BLOCKS, ForceRegistry.FORCE_BRICK_YELLOW_STAIRS.get()).unlockedBy("has_bricks", has(ForceRegistry.FORCE_BRICK_YELLOW.get())).save(output, Reference.modLoc("force_brick_yellow_stairs_from_force_brick_yellow"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(ForceRegistry.FORCE_BRICK_GREEN.get()), RecipeCategory.BUILDING_BLOCKS, ForceRegistry.FORCE_BRICK_GREEN_STAIRS.get()).unlockedBy("has_bricks", has(ForceRegistry.FORCE_BRICK_GREEN.get())).save(output, Reference.modLoc("force_brick_green_stairs_from_force_brick_green"));
		...
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(ForceRegistry.FORCE_BRICK_WHITE.get()), RecipeCategory.BUILDING_BLOCKS, ForceRegistry.FORCE_BRICK_WHITE_STAIRS.get()).unlockedBy("has_bricks", has(ForceRegistry.FORCE_BRICK_WHITE.get())).save(output, Reference.modLoc("force_brick_white_stairs_from_force_brick_white"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(ForceRegistry.FORCE_BRICK_BLACK.get()), RecipeCategory.BUILDING_BLOCKS, ForceRegistry.FORCE_BRICK_BLACK_STAIRS.get()).unlockedBy("has_bricks", has(ForceRegistry.FORCE_BRICK_BLACK.get())).save(output, Reference.modLoc("force_brick_black_stairs_from_force_brick_black"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(ForceRegistry.FORCE_BRICK_BROWN.get()), RecipeCategory.BUILDING_BLOCKS, ForceRegistry.FORCE_BRICK_BROWN_STAIRS.get()).unlockedBy("has_bricks", has(ForceRegistry.FORCE_BRICK_BROWN.get())).save(output, Reference.modLoc("force_brick_brown_stairs_from_force_brick_brown"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(ForceRegistry.FORCE_BRICK_ORANGE.get()), RecipeCategory.BUILDING_BLOCKS, ForceRegistry.FORCE_BRICK_ORANGE_STAIRS.get()).unlockedBy("has_bricks", has(ForceRegistry.FORCE_BRICK_ORANGE.get())).save(output, Reference.modLoc("force_brick_orange_stairs_from_force_brick_orange"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(ForceRegistry.FORCE_BRICK_LIGHT_BLUE.get()), RecipeCategory.BUILDING_BLOCKS, ForceRegistry.FORCE_BRICK_LIGHT_BLUE_STAIRS.get()).unlockedBy("has_bricks", has(ForceRegistry.FORCE_BRICK_LIGHT_BLUE.get())).save(output, Reference.modLoc("force_brick_light_blue_stairs_from_force_brick_light_blue"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(ForceRegistry.FORCE_BRICK_MAGENTA.get()), RecipeCategory.BUILDING_BLOCKS, ForceRegistry.FORCE_BRICK_MAGENTA_STAIRS.get()).unlockedBy("has_bricks", has(ForceRegistry.FORCE_BRICK_MAGENTA.get())).save(output, Reference.modLoc("force_brick_magenta_stairs_from_force_brick_magenta"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(ForceRegistry.FORCE_BRICK_PINK.get()), RecipeCategory.BUILDING_BLOCKS, ForceRegistry.FORCE_BRICK_PINK_STAIRS.get()).unlockedBy("has_bricks", has(ForceRegistry.FORCE_BRICK_PINK.get())).save(output, Reference.modLoc("force_brick_pink_stairs_from_force_brick_pink"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(ForceRegistry.FORCE_BRICK_LIGHT_GRAY.get()), RecipeCategory.BUILDING_BLOCKS, ForceRegistry.FORCE_BRICK_LIGHT_GRAY_STAIRS.get()).unlockedBy("has_bricks", has(ForceRegistry.FORCE_BRICK_LIGHT_GRAY.get())).save(output, Reference.modLoc("force_brick_light_gray_stairs_from_force_brick_light_gray"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(ForceRegistry.FORCE_BRICK_LIME.get()), RecipeCategory.BUILDING_BLOCKS, ForceRegistry.FORCE_BRICK_LIME_STAIRS.get()).unlockedBy("has_bricks", has(ForceRegistry.FORCE_BRICK_LIME.get())).save(output, Reference.modLoc("force_brick_lime_stairs_from_force_brick_lime"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(ForceRegistry.FORCE_BRICK_CYAN.get()), RecipeCategory.BUILDING_BLOCKS, ForceRegistry.FORCE_BRICK_CYAN_STAIRS.get()).unlockedBy("has_bricks", has(ForceRegistry.FORCE_BRICK_CYAN.get())).save(output, Reference.modLoc("force_brick_cyan_stairs_from_force_brick_cyan"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(ForceRegistry.FORCE_BRICK_PURPLE.get()), RecipeCategory.BUILDING_BLOCKS, ForceRegistry.FORCE_BRICK_PURPLE_STAIRS.get()).unlockedBy("has_bricks", has(ForceRegistry.FORCE_BRICK_PURPLE.get())).save(output, Reference.modLoc("force_brick_purple_stairs_from_force_brick_purple"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(ForceRegistry.FORCE_BRICK_GRAY.get()), RecipeCategory.BUILDING_BLOCKS, ForceRegistry.FORCE_BRICK_GRAY_STAIRS.get()).unlockedBy("has_bricks", has(ForceRegistry.FORCE_BRICK_GRAY.get())).save(output, Reference.modLoc("force_brick_gray_stairs_from_force_brick_gray"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(ForceRegistry.FORCE_BRICK.get()), RecipeCategory.BUILDING_BLOCKS, ForceRegistry.FORCE_BRICK_STAIRS.get()).unlockedBy("has_bricks", has(ForceRegistry.FORCE_BRICK.get())).save(output, Reference.modLoc("force_brick_stairs_from_force_brick"));
		//Slabs
		...
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(ForceRegistry.FORCE_BRICK_RED.get()), RecipeCategory.BUILDING_BLOCKS, ForceRegistry.FORCE_BRICK_RED_SLAB.get(), 2).unlockedBy("has_bricks", has(ForceRegistry.FORCE_BRICK_RED.get())).save(output, Reference.modLoc("force_brick_red_slab_from_force_brick_red"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(ForceRegistry.FORCE_BRICK_YELLOW.get()), RecipeCategory.BUILDING_BLOCKS, ForceRegistry.FORCE_BRICK_YELLOW_SLAB.get(), 2).unlockedBy("has_bricks", has(ForceRegistry.FORCE_BRICK_YELLOW.get())).save(output, Reference.modLoc("force_brick_yellow_slab_from_force_brick_yellow"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(ForceRegistry.FORCE_BRICK_GREEN.get()), RecipeCategory.BUILDING_BLOCKS, ForceRegistry.FORCE_BRICK_GREEN_SLAB.get(), 2).unlockedBy("has_bricks", has(ForceRegistry.FORCE_BRICK_GREEN.get())).save(output, Reference.modLoc("force_brick_green_slab_from_force_brick_green"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(ForceRegistry.FORCE_BRICK_BLUE.get()), RecipeCategory.BUILDING_BLOCKS, ForceRegistry.FORCE_BRICK_BLUE_SLAB.get(), 2).unlockedBy("has_bricks", has(ForceRegistry.FORCE_BRICK_BLUE.get())).save(output, Reference.modLoc("force_brick_blue_slab_from_force_brick_blue"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(ForceRegistry.FORCE_BRICK_WHITE.get()), RecipeCategory.BUILDING_BLOCKS, ForceRegistry.FORCE_BRICK_WHITE_SLAB.get(), 2).unlockedBy("has_bricks", has(ForceRegistry.FORCE_BRICK_WHITE.get())).save(output, Reference.modLoc("force_brick_white_slab_from_force_brick_white"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(ForceRegistry.FORCE_BRICK_BLACK.get()), RecipeCategory.BUILDING_BLOCKS, ForceRegistry.FORCE_BRICK_BLACK_SLAB.get(), 2).unlockedBy("has_bricks", has(ForceRegistry.FORCE_BRICK_BLACK.get())).save(output, Reference.modLoc("force_brick_black_slab_from_force_brick_black"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(ForceRegistry.FORCE_BRICK_BROWN.get()), RecipeCategory.BUILDING_BLOCKS, ForceRegistry.FORCE_BRICK_BROWN_SLAB.get(), 2).unlockedBy("has_bricks", has(ForceRegistry.FORCE_BRICK_BROWN.get())).save(output, Reference.modLoc("force_brick_brown_slab_from_force_brick_brown"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(ForceRegistry.FORCE_BRICK_ORANGE.get()), RecipeCategory.BUILDING_BLOCKS, ForceRegistry.FORCE_BRICK_ORANGE_SLAB.get(), 2).unlockedBy("has_bricks", has(ForceRegistry.FORCE_BRICK_ORANGE.get())).save(output, Reference.modLoc("force_brick_orange_slab_from_force_brick_orange"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(ForceRegistry.FORCE_BRICK_LIGHT_BLUE.get()), RecipeCategory.BUILDING_BLOCKS, ForceRegistry.FORCE_BRICK_LIGHT_BLUE_SLAB.get(), 2).unlockedBy("has_bricks", has(ForceRegistry.FORCE_BRICK_LIGHT_BLUE.get())).save(output, Reference.modLoc("force_brick_light_blue_slab_from_force_brick_light_blue"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(ForceRegistry.FORCE_BRICK_MAGENTA.get()), RecipeCategory.BUILDING_BLOCKS, ForceRegistry.FORCE_BRICK_MAGENTA_SLAB.get(), 2).unlockedBy("has_bricks", has(ForceRegistry.FORCE_BRICK_MAGENTA.get())).save(output, Reference.modLoc("force_brick_magenta_slab_from_force_brick_magenta"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(ForceRegistry.FORCE_BRICK_PINK.get()), RecipeCategory.BUILDING_BLOCKS, ForceRegistry.FORCE_BRICK_PINK_SLAB.get(), 2).unlockedBy("has_bricks", has(ForceRegistry.FORCE_BRICK_PINK.get())).save(output, Reference.modLoc("force_brick_pink_slab_from_force_brick_pink"));
		...
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(ForceRegistry.FORCE_BRICK_LIME.get()), RecipeCategory.BUILDING_BLOCKS, ForceRegistry.FORCE_BRICK_LIME_SLAB.get(), 2).unlockedBy("has_bricks", has(ForceRegistry.FORCE_BRICK_LIME.get())).save(output, Reference.modLoc("force_brick_lime_slab_from_force_brick_lime"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(ForceRegistry.FORCE_BRICK_CYAN.get()), RecipeCategory.BUILDING_BLOCKS, ForceRegistry.FORCE_BRICK_CYAN_SLAB.get(), 2).unlockedBy("has_bricks", has(ForceRegistry.FORCE_BRICK_CYAN.get())).save(output, Reference.modLoc("force_brick_cyan_slab_from_force_brick_cyan"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(ForceRegistry.FORCE_BRICK_PURPLE.get()), RecipeCategory.BUILDING_BLOCKS, ForceRegistry.FORCE_BRICK_PURPLE_SLAB.get(), 2).unlockedBy("has_bricks", has(ForceRegistry.FORCE_BRICK_PURPLE.get())).save(output, Reference.modLoc("force_brick_purple_slab_from_force_brick_purple"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(ForceRegistry.FORCE_BRICK_GRAY.get()), RecipeCategory.BUILDING_BLOCKS, ForceRegistry.FORCE_BRICK_GRAY_SLAB.get(), 2).unlockedBy("has_bricks", has(ForceRegistry.FORCE_BRICK_GRAY.get())).save(output, Reference.modLoc("force_brick_gray_slab_from_force_brick_gray"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(ForceRegistry.FORCE_BRICK.get()), RecipeCategory.BUILDING_BLOCKS, ForceRegistry.FORCE_BRICK_SLAB.get(), 2).unlockedBy("has_bricks", has(ForceRegistry.FORCE_BRICK.get())).save(output, Reference.modLoc("force_brick_slab_from_force_brick"));
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, getGuideBook())
				...
				.save(output, Reference.modLoc("force_and_you"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, Items.GUNPOWDER)
				...
				.save(output, Reference.modLoc("gunpowder_from_pile_of_gunpowder"));
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ForceRegistry.WHITE_FORCE_FURNACE.get())
				...
				.save(output, Reference.modLoc("white_force_furnace_from_dye"));
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ForceRegistry.ORANGE_FORCE_FURNACE.get())
				...
				.save(output, Reference.modLoc("orange_force_furnace_from_dye"));
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ForceRegistry.MAGENTA_FORCE_FURNACE.get())
				...
				.save(output, Reference.modLoc("magenta_force_furnace_from_dye"));
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ForceRegistry.FORCE_FURNACE.get())
				...
				.save(output, Reference.modLoc("force_furnace_from_dye"));
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ForceRegistry.LIME_FORCE_FURNACE.get())
				...
				.save(output, Reference.modLoc("lime_force_furnace_from_dye"));
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ForceRegistry.PINK_FORCE_FURNACE.get())
				...
				.save(output, Reference.modLoc("pink_force_furnace_from_dye"));
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ForceRegistry.GRAY_FORCE_FURNACE.get())
				...
				.save(output, Reference.modLoc("gray_force_furnace_from_dye"));
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ForceRegistry.LIGHT_GRAY_FORCE_FURNACE.get())
				...
				.save(output, Reference.modLoc("light_gray_force_furnace_from_dye"));
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ForceRegistry.CYAN_FORCE_FURNACE.get())
				...
				.save(output, Reference.modLoc("cyan_force_furnace_from_dye"));
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ForceRegistry.PURPLE_FORCE_FURNACE.get())
				...
				.save(output, Reference.modLoc("purple_force_furnace_from_dye"));
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ForceRegistry.BLUE_FORCE_FURNACE.get())
				...
				.save(output, Reference.modLoc("blue_force_furnace_from_dye"));
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ForceRegistry.BROWN_FORCE_FURNACE.get())
				...
				.save(output, Reference.modLoc("brown_force_furnace_from_dye"));
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ForceRegistry.GREEN_FORCE_FURNACE.get())
				...
				.save(output, Reference.modLoc("green_force_furnace_from_dye"));
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ForceRegistry.RED_FORCE_FURNACE.get())
				...
				.save(output, Reference.modLoc("red_force_furnace_from_dye"));
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ForceRegistry.BLACK_FORCE_FURNACE.get())
				...
				.save(output, Reference.modLoc("black_force_furnace_from_dye"));
...
//				.save(output);
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, damagedRod)
				...
				.unlockedBy("has_force_nugget", has(ForceTags.FORCE_NUGGET))
				.unlockedBy("has_force_rod", has(ForceTags.FORCE_ROD))
				.save(output, Reference.modLoc("force_rod_from_stick"));
		//Armor
		...
		NoRemainderShapedBuilder.shaped(RecipeCategory.MISC, ForceRegistry.FORCE_FLASK.get())
				...
				.save(output, Reference.modLoc("force_flask_from_entity_flask"));
		//Fortune Cookie
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ForceRegistry.FORCE_INGOT.get(), 3)
				...
				.save(output, Reference.modLoc("force_ingot_from_gold"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ForceRegistry.ITEM_CARD.get())
				...
				.unlockedBy("has_red_dye", has(Tags.Items.DYES_RED))
				.unlockedBy("has_blue_dye", has(Tags.Items.DYES_BLUE))
				.save(output, Reference.modLoc("item_card_flipped"));
		NoRemainderShapedBuilder.shaped(RecipeCategory.MISC, ForceRegistry.ITEM_CARD.get())
				...
				.save(output, Reference.modLoc("item_card_empty"));
		//Magnet Glove
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, Items.SLIME_BALL)
				...
				.save(output, Reference.modLoc("slime_ball_from_chu_jelly"));
		//Snow Cookie
	...
	private void addInfuserRecipes(RecipeOutput output) {
		...
		InfuseRecipeBuilder.infuse(
				...
				.save(output, Reference.modLoc("infuser/infuse_damage"));
		InfuseRecipeBuilder.infuse(
				...
				.save(output, Reference.modLoc("infuser/infuse_knockback"));
		...
		InfuseRecipeBuilder.infuse(
				...
				.save(output, Reference.modLoc("infuser/infuse_speed"));
		...
		InfuseRecipeBuilder.infuse(
				...
				.save(output, Reference.modLoc("infuser/convert_freezing"));
		InfuseRecipeBuilder.infuse(
				...
				.save(output, Reference.modLoc("infuser/convert_grinding"));
		InfuseRecipeBuilder.infuse(
						Ingredient.of(Items.SUGAR),
						Ingredient.of(ForceRegistry.UPGRADE_CORE.get()),
						UpgradeBookTier.TWO,
				...
				.save(output, Reference.modLoc("infuser/convert_speed"));
		InfuseRecipeBuilder.infuse(
				...
				.save(output, Reference.modLoc("infuser/convert_xp"));
		InfuseRecipeBuilder.infuse(
						Ingredient.of(Items.EXPERIENCE_BOTTLE),
				...
				.save(output, Reference.modLoc("infuser/convert_xp_book"));
		InfuseRecipeBuilder.infuse(
				...
				.save(output, Reference.modLoc("infuser/infuse_fortune"));
		InfuseRecipeBuilder.infuse(
						Ingredient.of(ForceRegistry.SNOW_COOKIE.get()),
				...
				.save(output, Reference.modLoc("infuser/infuse_freezing"));
		InfuseRecipeBuilder.infuse(
		...
		InfuseRecipeBuilder.infuse(
				...
				.save(output, Reference.modLoc("infuser/infuse_pack_upgrade1"));
		...
		InfuseRecipeBuilder.infuse(
				...
				.save(output, Reference.modLoc("infuser/infuse_bleeding"));
		InfuseRecipeBuilder.infuse(
		...
		InfuseRecipeBuilder.infuse(
				...
				.save(output, Reference.modLoc("infuser/infuse_camo"));
		InfuseRecipeBuilder.infuse(
						Ingredient.of(ForceRegistry.FORCE_PACK_UPGRADE.get()),
						Ingredient.of(ForceRegistry.FORCE_PACK.get()),
						UpgradeBookTier.THREE,
				...
				.save(output, Reference.modLoc("infuser/infuse_pack_upgrade2"));
		...
		InfuseRecipeBuilder.infuse(
				...
				.save(output, Reference.modLoc("infuser/convert_heat"));
		InfuseRecipeBuilder.infuse(
		...
		InfuseRecipeBuilder.infuse(
				...
				.save(output, Reference.modLoc("infuser/infuse_pack_upgrade3"));
		...
		InfuseRecipeBuilder.infuse(
				...
				.save(output, Reference.modLoc("infuser/infuse_healing"));
		InfuseRecipeBuilder.infuse(
				...
				.save(output, Reference.modLoc("infuser/infuse_wing"));
		...
		InfuseRecipeBuilder.infuse(
				...
				.save(output.withConditions(new TorchEnabledCondition()), Reference.modLoc("infuser/convert_time_torch"));
		InfuseRecipeBuilder.infuse(
				...
				.save(output, Reference.modLoc("infuser/infuse_sturdy"));
		InfuseRecipeBuilder.infuse(
				...
				.save(output, Reference.modLoc("infuser/infuse_ender"));
		//7
		InfuseRecipeBuilder.infuse(
				...
				.save(output, Reference.modLoc("infuser/infuse_light"));
		InfuseRecipeBuilder.infuse(
	...
	private void addMultiOutputRecipes(RecipeOutput output) {
		MultipleOutputRecipeBuilder.freezing(Ingredient.of(Tags.Items.RODS_BLAZE), 0.1F, 200)
				...
				.save(output, Reference.modLoc("freezing/bone_from_blaze_rod"));
		...
		MultipleOutputRecipeBuilder.freezing(DataComponentIngredient.of(false, DataComponentPredicate.builder()
				...
				.unlockedBy("has_core", has(ForceRegistry.FREEZING_CORE))
				.save(output, Reference.modLoc("freezing/ice_from_water_bottle"));
		...
		MultipleOutputRecipeBuilder.grinding(Ingredient.of(ItemTags.JUNGLE_LOGS), 1.0F, 0.1F, 400)
				...
				.unlockedBy("has_core", has(ForceRegistry.GRINDING_CORE))
				.save(output, Reference.modLoc("grinding/jungle_planks_from_log"));
		MultipleOutputRecipeBuilder.grinding(Items.JUNGLE_PRESSURE_PLATE, 1.0F, 0.1F, 400)
				.setResult(Items.JUNGLE_PLANKS, 2)
				.unlockedBy("has_core", has(ForceRegistry.GRINDING_CORE))
				.save(output, Reference.modLoc("grinding/jungle_planks_from_pressure_plate"));
		//Cherry
		...
		MultipleOutputRecipeBuilder.grinding(Ingredient.of(ItemTags.CRIMSON_STEMS), 1.0F, 0.1F, 400)
				...
				.unlockedBy("has_core", has(ForceRegistry.GRINDING_CORE))
				.save(output, Reference.modLoc("grinding/crimson_planks_from_log"));
		MultipleOutputRecipeBuilder.grinding(Items.CRIMSON_PRESSURE_PLATE, 1.0F, 0.1F, 400)
				.setResult(Items.CRIMSON_PLANKS, 2)
				.unlockedBy("has_core", has(ForceRegistry.GRINDING_CORE))
				.save(output, Reference.modLoc("grinding/crimson_planks_from_pressure_plate"));
		//Warped
		MultipleOutputRecipeBuilder.grinding(Items.WARPED_DOOR, 1.0F, 0.1F, 400)
				.setResult(Items.WARPED_PLANKS, 2)
				.unlockedBy("has_core", has(ForceRegistry.GRINDING_CORE))
				.save(output, Reference.modLoc("grinding/warped_planks_from_door"));
		...
		MultipleOutputRecipeBuilder.grinding(ForceRegistry.FORCE_LOG.get(), 1.0F, 0.1F, 400)
				...
				.unlockedBy("has_core", has(ForceRegistry.GRINDING_CORE))
				.save(output, Reference.modLoc("grinding/force_planks_from_log"));
		...
		MultipleOutputRecipeBuilder.grinding(Items.FURNACE, 1.0F, 0.1F, 400)
				...
				.unlockedBy("has_core", has(ForceRegistry.GRINDING_CORE))
				.save(output, Reference.modLoc("grinding/cobblestone_from_furnace"));
	...
	private void addTransmutationRecipes(RecipeOutput output) {
		...
		TransmutationRecipeBuilder.transmutation(Items.COOKED_CHICKEN)
				...
				.save(output, Reference.modLoc("transmutation/cooked_mutton_to_chicken"));
		TransmutationRecipeBuilder.transmutation(Items.COOKED_MUTTON)
				.requires(Items.COOKED_PORKCHOP)
				.unlockedBy("has_porkchop", has(Items.COOKED_PORKCHOP))
				.save(output, Reference.modLoc("transmutation/cooked_porkchop_to_mutton"));
		...
		TransmutationRecipeBuilder.transmutation(Items.DANDELION)
				...
				.save(output, Reference.modLoc("transmutation/poppy_to_dandelion"));
		...
		TransmutationRecipeBuilder.transmutation(Items.DIAMOND, 2)
				...
				.save(output, Reference.modLoc("transmutation/diamond_from_axe"));
		TransmutationRecipeBuilder.transmutation(Items.DIAMOND, 2)
				.requires(Items.DIAMOND_HOE)
				.unlockedBy("has_tool", has(Items.DIAMOND_HOE))
				.save(output, Reference.modLoc("transmutation/diamond_from_hoe"));
		TransmutationRecipeBuilder.transmutation(Items.DIAMOND, 1)
				...
				.save(output, Reference.modLoc("transmutation/diamond_from_shovel"));
		TransmutationRecipeBuilder.transmutation(Items.DIAMOND, 2)
				.requires(Items.DIAMOND_SWORD)
				.unlockedBy("has_tool", has(Items.DIAMOND_SWORD))
				.save(output, Reference.modLoc("transmutation/diamond_from_sword"));
		TransmutationRecipeBuilder.transmutation(Items.DIAMOND, 2)
				.requires(Items.DIAMOND_PICKAXE)
				.unlockedBy("has_tool", has(Items.DIAMOND_PICKAXE))
				.save(output, Reference.modLoc("transmutation/diamond_from_pickaxe"));
		TransmutationRecipeBuilder.transmutation(Items.DIAMOND, 4)
				...
				.save(output, Reference.modLoc("transmutation/diamond_from_boots"));
		TransmutationRecipeBuilder.transmutation(Items.DIAMOND, 7)
				...
				.save(output, Reference.modLoc("transmutation/diamond_from_leggings"));
		...
		TransmutationRecipeBuilder.transmutation(Items.DIAMOND, 5)
				...
				.save(output, Reference.modLoc("transmutation/diamond_from_helmet"));
		TransmutationRecipeBuilder.transmutation(Items.DIAMOND, 4)
				.requires(Items.DIAMOND_HORSE_ARMOR)
				.unlockedBy("has_horse_armor", has(Items.DIAMOND_HORSE_ARMOR))
				.save(output, Reference.modLoc("transmutation/diamond_from_horse_armor"));
		...
		TransmutationRecipeBuilder.transmutation(Items.GOLD_INGOT, 2)
				...
				.save(output, Reference.modLoc("transmutation/gold_ingot_from_axe"));
		TransmutationRecipeBuilder.transmutation(Items.GOLD_INGOT, 2)
				.requires(Items.GOLDEN_HOE)
				.unlockedBy("has_tool", has(Items.GOLDEN_HOE))
				.save(output, Reference.modLoc("transmutation/gold_ingot_from_hoe"));
		TransmutationRecipeBuilder.transmutation(Items.GOLD_INGOT, 1)
				...
				.save(output, Reference.modLoc("transmutation/gold_ingot_from_shovel"));
		TransmutationRecipeBuilder.transmutation(Items.GOLD_INGOT, 2)
				.requires(Items.GOLDEN_SWORD)
				.unlockedBy("has_tool", has(Items.GOLDEN_SWORD))
				.save(output, Reference.modLoc("transmutation/gold_ingot_from_sword"));
		TransmutationRecipeBuilder.transmutation(Items.GOLD_INGOT, 2)
				.requires(Items.GOLDEN_PICKAXE)
				.unlockedBy("has_tool", has(Items.GOLDEN_PICKAXE))
				.save(output, Reference.modLoc("transmutation/gold_ingot_from_pickaxe"));
		TransmutationRecipeBuilder.transmutation(Items.GOLD_INGOT, 4)
				...
				.save(output, Reference.modLoc("transmutation/gold_ingot_from_boots"));
		TransmutationRecipeBuilder.transmutation(Items.GOLD_INGOT, 7)
				...
				.save(output, Reference.modLoc("transmutation/gold_ingot_from_leggings"));
		TransmutationRecipeBuilder.transmutation(Items.GOLD_INGOT, 8)
				...
				.save(output, Reference.modLoc("transmutation/gold_ingot_from_chestplate"));
		TransmutationRecipeBuilder.transmutation(Items.GOLD_INGOT, 5)
				...
				.save(output, Reference.modLoc("transmutation/gold_ingot_from_helmet"));
		TransmutationRecipeBuilder.transmutation(Items.GOLD_INGOT, 4)
				.requires(Items.GOLDEN_HORSE_ARMOR)
				.unlockedBy("has_horse_armor", has(Items.GOLDEN_HORSE_ARMOR))
				.save(output, Reference.modLoc("transmutation/gold_ingot_from_horse_armor"));
		TransmutationRecipeBuilder.transmutation(Items.GOLD_INGOT, 4)
		...
		TransmutationRecipeBuilder.transmutation(Items.IRON_INGOT, 2)
				...
				.save(output, Reference.modLoc("transmutation/iron_ingot_from_axe"));
		TransmutationRecipeBuilder.transmutation(Items.IRON_INGOT, 2)
				.requires(Items.IRON_HOE)
				.unlockedBy("has_tool", has(Items.IRON_HOE))
				.save(output, Reference.modLoc("transmutation/iron_ingot_from_hoe"));
		TransmutationRecipeBuilder.transmutation(Items.IRON_INGOT, 1)
				...
				.save(output, Reference.modLoc("transmutation/iron_ingot_from_shovel"));
		TransmutationRecipeBuilder.transmutation(Items.IRON_INGOT, 2)
				.requires(Items.IRON_SWORD)
				.unlockedBy("has_tool", has(Items.IRON_SWORD))
				.save(output, Reference.modLoc("transmutation/iron_ingot_from_sword"));
		TransmutationRecipeBuilder.transmutation(Items.IRON_INGOT, 2)
				.requires(Items.IRON_PICKAXE)
				.unlockedBy("has_tool", has(Items.IRON_PICKAXE))
				.save(output, Reference.modLoc("transmutation/iron_ingot_from_pickaxe"));
		TransmutationRecipeBuilder.transmutation(Items.IRON_INGOT, 4)
				...
				.save(output, Reference.modLoc("transmutation/iron_ingot_from_boots"));
		TransmutationRecipeBuilder.transmutation(Items.IRON_INGOT, 7)
				...
				.save(output, Reference.modLoc("transmutation/iron_ingot_from_leggings"));
		...
		TransmutationRecipeBuilder.transmutation(Items.IRON_INGOT, 5)
				...
				.save(output, Reference.modLoc("transmutation/iron_ingot_from_helmet"));
		TransmutationRecipeBuilder.transmutation(Items.IRON_INGOT, 2)
		...
		TransmutationRecipeBuilder.transmutation(Items.IRON_INGOT, 4)
				...
				.save(output, Reference.modLoc("transmutation/iron_ingot_from_chainmail_leggings"));
		TransmutationRecipeBuilder.transmutation(Items.IRON_INGOT, 6)
				...
				.save(output, Reference.modLoc("transmutation/iron_ingot_from_chainmail_chestplate"));
		TransmutationRecipeBuilder.transmutation(Items.IRON_INGOT, 3)
				...
				.save(output, Reference.modLoc("transmutation/iron_ingot_from_chainmail_helmet"));
		TransmutationRecipeBuilder.transmutation(Items.IRON_INGOT, 4)
				.requires(Items.IRON_HORSE_ARMOR)
				.unlockedBy("has_horse_armor", has(Items.IRON_HORSE_ARMOR))
				.save(output, Reference.modLoc("transmutation/iron_ingot_from_horse_armor"));
		TransmutationRecipeBuilder.transmutation(Items.IRON_INGOT, 4)
		...
		TransmutationRecipeBuilder.transmutation(Items.IRON_INGOT, 7)
				...
				.save(output, Reference.modLoc("transmutation/irom_ingot_from_cauldron"));
		TransmutationRecipeBuilder.transmutation(Items.IRON_INGOT, 3)
				.requires(Items.BUCKET)
				.unlockedBy("has_bucket", has(Items.BUCKET))
				.save(output, Reference.modLoc("transmutation/iron_ingot_from_bucket"));
		TransmutationRecipeBuilder.transmutation(Items.IRON_INGOT, 2)
				.requires(Items.IRON_DOOR)
				.unlockedBy("has_door", has(Items.IRON_DOOR))
				.save(output, Reference.modLoc("transmutation/iron_ingot_from_door"));
		TransmutationRecipeBuilder.transmutation(Items.IRON_INGOT, 5)
				.requires(Items.MINECART)
				.unlockedBy("has_minecart", has(Items.MINECART))
				.save(output, Reference.modLoc("transmutation/iron_ingot_from_minecart"));
		TransmutationRecipeBuilder.transmutation(Items.IRON_INGOT, 31)
				.requires(Items.ANVIL)
				.unlockedBy("has_anvil", has(Items.ANVIL))
				.save(output, Reference.modLoc("transmutation/iron_ingot_from_anvil"));
		...
		TransmutationRecipeBuilder.transmutation(ForceRegistry.FORCE_BRICK)
				...
				.save(output, Reference.modLoc("transmutation/force_brick_from_stone_bricks"));
		...
		TransmutationRecipeBuilder.transmutation(Items.EXPERIENCE_BOTTLE)
				...
				.save(output, Reference.modLoc("transmutation/experience_bottle_from_enchanted_book"));
		TransmutationRecipeBuilder.transmutation(ForceRegistry.FORTUNE.get())
				...
				.save(output, Reference.modLoc("transmutation/fortune_from_fortune_cookie"));
		...
		TransmutationRecipeBuilder.transmutation(Items.STRING)
				...
				.save(output, Reference.modLoc("transmutation/string_from_bow"));
		...
		TransmutationRecipeBuilder.transmutation(Items.STICK)
				...
				.save(output, Reference.modLoc("transmutation/stick_from_stone_axe"));
		TransmutationRecipeBuilder.transmutation(Items.STICK)
				.requires(Items.STONE_HOE)
				.unlockedBy("has_tool", has(Items.STONE_HOE))
				.save(output, Reference.modLoc("transmutation/stick_from_stone_hoe"));
		TransmutationRecipeBuilder.transmutation(Items.STICK)
		...
		TransmutationRecipeBuilder.transmutation(Items.STICK)
				...
				.save(output, Reference.modLoc("transmutation/stick_from_wooden_axe"));
		TransmutationRecipeBuilder.transmutation(Items.STICK)
				.requires(Items.WOODEN_HOE)
				.unlockedBy("has_tool", has(Items.WOODEN_HOE))
				.save(output, Reference.modLoc("transmutation/stick_from_wooden_hoe"));
		TransmutationRecipeBuilder.transmutation(Items.STICK)
				.requires(Items.WOODEN_PICKAXE)
				.unlockedBy("has_tool", has(Items.WOODEN_PICKAXE))
				.save(output, Reference.modLoc("transmutation/stick_from_wooden_pickaxe"));
		TransmutationRecipeBuilder.transmutation(Items.STICK)
				.requires(Items.WOODEN_SHOVEL)
				.unlockedBy("has_tool", has(Items.WOODEN_SHOVEL))
				.save(output, Reference.modLoc("transmutation/stick_from_wooden_shovel"));
		TransmutationRecipeBuilder.transmutation(Items.STICK)
				.requires(Items.WOODEN_SWORD)
				.unlockedBy("has_tool", has(Items.WOODEN_SWORD))
				.save(output, Reference.modLoc("transmutation/stick_from_wooden_sword"));
