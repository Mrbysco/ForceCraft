...
public class ForceDamageTypeTags extends TagsProvider<DamageType> {
	public ForceDamageTypeTags(PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider, ExistingFileHelper existingFileHelper) {
