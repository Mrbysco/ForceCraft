...
public class ShapelessStackRecipeBuilder extends CraftingRecipeBuilder implements RecipeBuilder {
	...
	public ShapelessStackRecipeBuilder(RecipeCategory recipeCategory, ItemStack stack) {
	...
	public void save(Consumer<FinishedRecipe> p_126205_, ResourceLocation p_126206_) {
		...
		p_126205_.accept(new ShapelessStackRecipeBuilder.Result(p_126206_, this.resultStack, this.group == null ? "" : this.group, determineBookCategory(this.category), this.ingredients, this.advancement, p_126206_.withPrefix("recipes/" + this.category.getFolderName() + "/")));
	}
	...
	public static class Result extends CraftingRecipeBuilder.CraftingResult {
		...
		public Result(ResourceLocation p_249007_, ItemStack stack, String p_248592_, CraftingBookCategory p_249485_, List<Ingredient> p_252312_, Advancement.Builder p_249909_, ResourceLocation p_249109_) {
			super(p_249485_);
			this.id = p_249007_;
			this.result = stack;
