...
public class NoRemainderShapedBuilder extends CraftingRecipeBuilder implements RecipeBuilder {
	...
	public NoRemainderShapedBuilder(RecipeCategory p_249996_, ItemStack stack) {
		this.category = p_249996_;
		this.result = stack.getItem();
		this.resultStack = stack;
	}

	public static NoRemainderShapedBuilder shaped(RecipeCategory recipeCategory, ItemLike itemLike) {
		return new NoRemainderShapedBuilder(recipeCategory, itemLike.asItem().getDefaultInstance());
	}

	public NoRemainderShapedBuilder define(Character p_206417_, TagKey<Item> p_206418_) {
		return this.define(p_206417_, Ingredient.of(p_206418_));
	}

	public NoRemainderShapedBuilder define(Character p_126128_, ItemLike p_126129_) {
		return this.define(p_126128_, Ingredient.of(p_126129_));
	}

	public NoRemainderShapedBuilder define(Character p_126125_, Ingredient p_126126_) {
	...
	public NoRemainderShapedBuilder pattern(String p_126131_) {
	...
	public NoRemainderShapedBuilder unlockedBy(String p_126133_, CriterionTriggerInstance p_126134_) {
		this.advancement.addCriterion(p_126133_, p_126134_);
		return this;
	}

	public NoRemainderShapedBuilder group(@org.jetbrains.annotations.Nullable String p_126146_) {
		this.group = p_126146_;
		return this;
	}

	public NoRemainderShapedBuilder showNotification(boolean p_273326_) {
	...
	public void save(Consumer<FinishedRecipe> p_126141_, ResourceLocation p_126142_) {
		...
		p_126141_.accept(new NoRemainderShapedBuilder.Result(p_126142_, this.resultStack, this.group == null ? "" : this.group, determineBookCategory(this.category), this.rows, this.key, this.advancement, p_126142_.withPrefix("recipes/" + this.category.getFolderName() + "/"), this.showNotification));
	}
	...
	public static class Result extends CraftingRecipeBuilder.CraftingResult {
		...
		public Result(ResourceLocation p_273548_, ItemStack result, String p_273549_, CraftingBookCategory p_273500_, List<String> p_273744_, Map<Character, Ingredient> p_272991_, Advancement.Builder p_273260_, ResourceLocation p_273106_, boolean p_272862_) {
			super(p_273500_);
			this.id = p_273548_;
			this.result = result;
		...
		public void serializeRecipeData(JsonObject p_126167_) {
			...
			if (this.result.hasTag()) {
				jsonobject1.addProperty("nbt", this.result.getTag().toString());
			}
