...
public class ShapedStackRecipeBuilder extends CraftingRecipeBuilder implements RecipeBuilder {
	...
	public ShapedStackRecipeBuilder(RecipeCategory p_249996_, ItemStack stack) {
		this.category = p_249996_;
		this.result = stack.getItem();
		this.resultStack = stack;
	}

	public ShapedStackRecipeBuilder define(Character p_206417_, TagKey<Item> p_206418_) {
		return this.define(p_206417_, Ingredient.of(p_206418_));
	}

	public ShapedStackRecipeBuilder define(Character p_126128_, ItemLike p_126129_) {
		return this.define(p_126128_, Ingredient.of(p_126129_));
	}

	public ShapedStackRecipeBuilder define(Character p_126125_, Ingredient p_126126_) {
	...
	public ShapedStackRecipeBuilder pattern(String p_126131_) {
	...
	public ShapedStackRecipeBuilder unlockedBy(String p_126133_, CriterionTriggerInstance p_126134_) {
		this.advancement.addCriterion(p_126133_, p_126134_);
		return this;
	}

	public ShapedStackRecipeBuilder group(@Nullable String p_126146_) {
		this.group = p_126146_;
		return this;
	}

	public ShapedStackRecipeBuilder showNotification(boolean p_273326_) {
	...
	public void save(Consumer<FinishedRecipe> p_126141_, ResourceLocation p_126142_) {
		...
		p_126141_.accept(new ShapedStackRecipeBuilder.Result(p_126142_, this.resultStack, this.group == null ? "" : this.group, determineBookCategory(this.category), this.rows, this.key, this.advancement, p_126142_.withPrefix("recipes/" + this.category.getFolderName() + "/"), this.showNotification));
	}
