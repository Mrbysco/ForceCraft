...
public class ForceRegistry {
    ...
    public static final RegistryObject<Block> FORCE_ORANGE_TORCH = BLOCKS.register("force_orange_torch", () -> new TorchBlock(AbstractBlock.Properties.create(Material.MISCELLANEOUS, DyeColor.YELLOW).doesNotBlockMovement().zeroHardnessAndResistance().setLightLevel((state) -> 15).sound(SoundType.WOOD), ParticleTypes.FLAME));
    ...
    public static final RegistryObject<Block> WALL_FORCE_ORANGE_TORCH = BLOCKS.register("wall_force_orange_torch", () -> new WallTorchBlock(AbstractBlock.Properties.from(FORCE_ORANGE_TORCH.get()), ParticleTypes.FLAME));
    ...
    public static final RegistryObject<Item> FORCE_ORANGE_TORCH_ITEM = ITEMS.register("force_orange_torch", () -> new WallOrFloorItem(FORCE_ORANGE_TORCH.get(), WALL_FORCE_ORANGE_TORCH.get(), itemBuilder().group(ForceCraft.creativeTab)));
