...
public abstract class AbstractForceFurnaceScreen<T extends AbstractForceFurnaceContainer> extends ContainerScreen<T> implements IRecipeShownListener {
	...
	public AbstractForceFurnaceScreen(T screenContainer, AbstractRecipeBookGui recipeGuiIn, PlayerInventory inv, ITextComponent titleIn, ResourceLocation guiTextureIn) {
	...
	public void init() {
		...
		this.addButton(new ImageButton(this.guiLeft + 20, this.height / 2 - 39, 20, 18, 0, 0, 19, BUTTON_TEXTURE, (button) -> {
